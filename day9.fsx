...
let input = File.ReadAllText "inputs/day9.txt"
...
let addConn (a, b, distance) (g: Graph) =
    let newConn =
        ...
        | None -> g.Connections.Add(a, Map.ofList [b, distance])
        | Some m -> g.Connections.Add(a, m.Add(b, distance))
